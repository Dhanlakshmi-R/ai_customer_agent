...
async def get_settings(
    ...
    openai_key = await repo.get_setting("openai_api_key") or settings.OPENAI_API_KEY or ""
    gemini_key = await repo.get_setting("gemini_api_key") or settings.GEMINI_API_KEY or ""

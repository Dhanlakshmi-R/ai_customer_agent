...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="hidden md:flex w-72 bg-slate-900/95 backdrop-blur-xl border-r border-slate-800 text-slate-300 flex-col h-screen sticky top-0 z-30">
      {/* Brand Header */}
      <div className="relative p-5 flex items-center gap-3 border-b border-slate-800 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-600/10 via-transparent to-purple-600/5 pointer-events-none" />
        <div className="relative w-10 h-10 rounded-2xl bg-gradient-to-tr from-indigo-500 via-violet-500 to-cyan-400 flex items-center justify-center text-white shadow-lg shadow-indigo-500/30 ring-1 ring-white/10">
          <Sparkles className="w-5 h-5" />
        </div>
        <div className="relative">
          <h1 className="font-bold text-slate-100 text-sm tracking-wide flex items-center gap-1.5">
            NovaDesk AI
          </h1>
